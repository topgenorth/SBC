...
namespace SimpleBallistics.BallisticsLib
{
    class Ballistics
    {
        ...
        public static double AtmCorrect(double DragCoefficient,
            double Altitude,
            double Barometer,
            double Temperature,
        ...
        /// <returns></returns>
        public static List<Dictionary<string, double>> SolveAll(__DragFunctions DragFunction,
            ...
            double WindAngle)
        {
            ...
            var items = new List<Dictionary<string, double>>();
        ...
        /// <returns></returns>
        public static double ZeroAngle(__DragFunctions DragFunction,
            double DragCoefficient,
            double Vi,
            double SightHeight,
            double ZeroRange,
            double yIntercept)
        {
            ...
            double t = 0;
            var dt = 1 /
                     Vi; // The solution accuracy generally doesn't suffer if its within a foot for each second of time.
        ...
        {
            var VPw = 4e-6 * Math.Pow(Temperature, 3) - 0.0004 * Math.Pow(Temperature, 2) + 0.0234 * Temperature -
                      0.2517;
